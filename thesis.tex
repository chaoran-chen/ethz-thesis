...
\documentclass[%
    ...
    abstractoff,%
    BCOR=6.5mm, paper=a5, fontsize=10pt,% A5 soft cover
...
% Bibliography
\addbibresource[label=introduction]{chapters/introduction/main.bib}
\addbibresource[label=chapter1]{chapters/chapter1/main.bib}
\addbibresource[label=discussion]{chapters/discussion/main.bib}
